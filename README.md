...
- Tastatur offen? In allen Rate-Kategorien (Wer bin ich, Bild, Logo, Song, Montagsmaler, Schätzfrage) schaltet die
  Seite auf ein kompaktes Layout ohne Seiten-Scroll: Der sichtbare Ausschnitt wird festgehalten, Tipps, Bild oder
  Zeichnung sitzen oben, darunter der Chat, ganz unten die Eingabe. Das automatische Hochscrollen des Browsers wird
  rückgängig gemacht, Kopfzeile, Spielerliste und Roundmaster-Leiste blenden aus. So bleibt alles sichtbar, auch beim
  Korrigieren.
